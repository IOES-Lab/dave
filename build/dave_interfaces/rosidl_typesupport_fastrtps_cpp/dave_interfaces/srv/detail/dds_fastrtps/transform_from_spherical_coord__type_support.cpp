...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
max_serialized_size_key_TransformFromSphericalCoord_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
max_serialized_size_key_TransformFromSphericalCoord_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for dave_interfaces::srv::TransformFromSphericalCoord_Request already declared above

// functions for dave_interfaces::srv::TransformFromSphericalCoord_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
cdr_serialize(
  const dave_interfaces::srv::TransformFromSphericalCoord_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dave_interfaces::srv::TransformFromSphericalCoord_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
max_serialized_size_TransformFromSphericalCoord_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dave_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_TransformFromSphericalCoord_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dave_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_TransformFromSphericalCoord_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dave_interfaces::srv::TransformFromSphericalCoord_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
max_serialized_size_key_TransformFromSphericalCoord_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dave_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_TransformFromSphericalCoord_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dave_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_TransformFromSphericalCoord_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const dave_interfaces::srv::TransformFromSphericalCoord_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dave_interfaces::srv::TransformFromSphericalCoord_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TransformFromSphericalCoord_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dave_interfaces::srv::TransformFromSphericalCoord_Event *>(
...
static size_t _TransformFromSphericalCoord_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TransformFromSphericalCoord_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TransformFromSphericalCoord_Event__callbacks = {
  "dave_interfaces::srv",
...
static rosidl_message_type_support_t _TransformFromSphericalCoord_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TransformFromSphericalCoord_Event__callbacks,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dave_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<dave_interfaces::srv::TransformFromSphericalCoord_Event>()
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_TransformFromSphericalCoord_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dave_interfaces, srv, TransformFromSphericalCoord_Event)() {
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_TransformFromSphericalCoord_Event__handle;
}
...
static const rosidl_service_type_support_t _TransformFromSphericalCoord__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TransformFromSphericalCoord__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dave_interfaces::srv::TransformFromSphericalCoord_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dave_interfaces::srv::TransformFromSphericalCoord_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dave_interfaces::srv::TransformFromSphericalCoord_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<dave_interfaces::srv::TransformFromSphericalCoord>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<dave_interfaces::srv::TransformFromSphericalCoord>,
