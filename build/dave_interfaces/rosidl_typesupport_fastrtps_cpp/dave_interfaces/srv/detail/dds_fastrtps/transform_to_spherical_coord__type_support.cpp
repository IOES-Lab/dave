...
#include "dave_interfaces/srv/detail/transform_to_spherical_coord__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const dave_interfaces::srv::TransformToSphericalCoord_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dave_interfaces::srv::TransformToSphericalCoord_Request & ros_message)
{
  // Member: input
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dave_interfaces::srv::TransformToSphericalCoord_Request;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
max_serialized_size_key_TransformToSphericalCoord_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const dave_interfaces::srv::TransformToSphericalCoord_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dave_interfaces::srv::TransformToSphericalCoord_Request *>(
    untyped_ros_message);
...
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_TransformToSphericalCoord_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dave_interfaces, srv, TransformToSphericalCoord_Request)() {
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_TransformToSphericalCoord_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
cdr_serialize(
  const dave_interfaces::srv::TransformToSphericalCoord_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: latitude_deg
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dave_interfaces::srv::TransformToSphericalCoord_Response & ros_message)
{
  // Member: latitude_deg
  cdr >> ros_message.latitude_deg;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dave_interfaces::srv::TransformToSphericalCoord_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
max_serialized_size_key_TransformToSphericalCoord_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const dave_interfaces::srv::TransformToSphericalCoord_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dave_interfaces::srv::TransformToSphericalCoord_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_TransformToSphericalCoord_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dave_interfaces, srv, TransformToSphericalCoord_Response)() {
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_TransformToSphericalCoord_Response__handle;
}
...
// functions for dave_interfaces::srv::TransformToSphericalCoord_Request already declared above

// functions for dave_interfaces::srv::TransformToSphericalCoord_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
cdr_serialize(
  const dave_interfaces::srv::TransformToSphericalCoord_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dave_interfaces::srv::TransformToSphericalCoord_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
max_serialized_size_TransformToSphericalCoord_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dave_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_TransformToSphericalCoord_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dave_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_TransformToSphericalCoord_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dave_interfaces::srv::TransformToSphericalCoord_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dave_interfaces
max_serialized_size_key_TransformToSphericalCoord_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dave_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_TransformToSphericalCoord_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        dave_interfaces::srv::typesupport_fastrtps_cpp::max_serialized_size_key_TransformToSphericalCoord_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const dave_interfaces::srv::TransformToSphericalCoord_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<dave_interfaces::srv::TransformToSphericalCoord_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TransformToSphericalCoord_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dave_interfaces::srv::TransformToSphericalCoord_Event *>(
...
static size_t _TransformToSphericalCoord_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TransformToSphericalCoord_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TransformToSphericalCoord_Event__callbacks = {
  "dave_interfaces::srv",
...
static rosidl_message_type_support_t _TransformToSphericalCoord_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TransformToSphericalCoord_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_TransformToSphericalCoord_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dave_interfaces, srv, TransformToSphericalCoord_Event)() {
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_TransformToSphericalCoord_Event__handle;
}
...
static const rosidl_service_type_support_t _TransformToSphericalCoord__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TransformToSphericalCoord__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dave_interfaces::srv::TransformToSphericalCoord_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dave_interfaces::srv::TransformToSphericalCoord_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<dave_interfaces::srv::TransformToSphericalCoord_Event>(),
...
{
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_TransformToSphericalCoord__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dave_interfaces, srv, TransformToSphericalCoord)() {
  return &dave_interfaces::srv::typesupport_fastrtps_cpp::_TransformToSphericalCoord__handle;
}
