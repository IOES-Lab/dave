...
#include "dave_interfaces/msg/detail/usbl_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dave_interfaces::msg::UsblCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dave_interfaces::msg::UsblCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dave_interfaces::msg::UsblCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _UsblCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const dave_interfaces::msg::UsblCommand *>(
...
static size_t _UsblCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_UsblCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _UsblCommand__callbacks = {
  "dave_interfaces::msg",
  "UsblCommand",
...
static rosidl_message_type_support_t _UsblCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_UsblCommand__callbacks,
...
{
  return &dave_interfaces::msg::typesupport_fastrtps_cpp::_UsblCommand__handle;
}
