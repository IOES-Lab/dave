...
#ifndef _WIN32
# define DEPRECATED__dave_interfaces__srv__SetOriginSphericalCoord_Event __attribute__((deprecated))
#else
# define DEPRECATED__dave_interfaces__srv__SetOriginSphericalCoord_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct SetOriginSphericalCoord_Event_
{
  using Type = SetOriginSphericalCoord_Event_<ContainerAllocator>;

  explicit SetOriginSphericalCoord_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit SetOriginSphericalCoord_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<dave_interfaces::srv::SetOriginSphericalCoord_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<dave_interfaces::srv::SetOriginSphericalCoord_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<dave_interfaces::srv::SetOriginSphericalCoord_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<dave_interfaces::srv::SetOriginSphericalCoord_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<dave_interfaces::srv::SetOriginSphericalCoord_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<dave_interfaces::srv::SetOriginSphericalCoord_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<dave_interfaces::srv::SetOriginSphericalCoord_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<dave_interfaces::srv::SetOriginSphericalCoord_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__dave_interfaces__srv__SetOriginSphericalCoord_Event
    std::shared_ptr<dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__dave_interfaces__srv__SetOriginSphericalCoord_Event
    std::shared_ptr<dave_interfaces::srv::SetOriginSphericalCoord_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const SetOriginSphericalCoord_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using SetOriginSphericalCoord_Event =
  dave_interfaces::srv::SetOriginSphericalCoord_Event_<std::allocator<void>>;
...
struct SetOriginSphericalCoord
{
  ...
  using Event = dave_interfaces::srv::SetOriginSphericalCoord_Event;
};
