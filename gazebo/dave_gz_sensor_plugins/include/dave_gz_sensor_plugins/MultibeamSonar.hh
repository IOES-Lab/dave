 ...
 *
*/
#ifndef DAVE_GZ_SENSOR_PLUGINS__MULTIBEAMSONAR_HH_
#define DAVE_GZ_SENSOR_PLUGINS__MULTIBEAMSONAR_HH_
...
namespace custom
{
  ...
  class MultibeamSonar : public gz::sensors::Sensor
  {
    ...
    /// \brief Set the current postiion of the robot, so the Multibeam Sonar can
    ...
    /// \return The latest position given to the MultibeamSonar.
