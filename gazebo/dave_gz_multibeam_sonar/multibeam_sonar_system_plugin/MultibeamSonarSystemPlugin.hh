 ...
 *
*/
#ifndef MULTIBEAMSONARSYSTEMPLUGIN_HH_
#define MULTIBEAMSONARSYSTEMPLUGIN_HH_
...
namespace custom
{
  ...
  class MultibeamSonarSystemPlugin:
    ...
    public gz::sim::ISystemPostUpdate
  {
    ...
    private: std::unordered_map<gz::sim::Entity,
        std::shared_ptr<MirroredCamera>> entitySensorMap;
  };
}
#endif