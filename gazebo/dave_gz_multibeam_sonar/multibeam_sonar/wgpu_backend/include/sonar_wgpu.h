...
SonarPhysicsEngine *sonar_wgpu_create(uint32_t n_beams,
                                      uint32_t n_rays,
                                      uint32_t n_freq,
                                      float sound_speed,
                                      float bandwidth,
...
float *sonar_wgpu_compute(SonarPhysicsEngine *engine,
                          const float *depth,
                          const float *normals,
                          const float *refl,
...
SonarPhysicsEngine *sonar_physics_create(uint32_t n_beams,
                                         uint32_t n_rays,
                                         uint32_t n_freq,
                                         float sound_speed,
                                         float bandwidth,
