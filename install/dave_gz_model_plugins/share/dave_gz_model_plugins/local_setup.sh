...
: ${AMENT_CURRENT_PREFIX:="/home/abhimanyu/dave_ws/src/dave/install/dave_gz_model_plugins"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/dave_gz_model_plugins/environment/pythonpath.sh"
